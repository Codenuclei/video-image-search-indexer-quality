...
async def _settings_out() -> SettingsOut:
    ...
    return SettingsOut(
        ...
        object_lane_enabled=runtime.object_lane_enabled,
        object_backfill_enabled=runtime.object_backfill_enabled,
        object_confidence_floor=runtime.object_confidence_floor,
        object_max_labels=runtime.object_max_labels,
        object_batch_size=runtime.object_batch_size,
        object_face_priority_ratio=runtime.object_face_priority_ratio,
        identify_lane_enabled=runtime.identify_lane_enabled,
        identify_backfill_enabled=runtime.identify_backfill_enabled,
...
async def write_settings(
    ...
    runtime = update_runtime_settings(
        ...
        object_lane_enabled=payload.object_lane_enabled,
        object_backfill_enabled=payload.object_backfill_enabled,
        object_confidence_floor=payload.object_confidence_floor,
        object_max_labels=payload.object_max_labels,
        object_batch_size=payload.object_batch_size,
        object_face_priority_ratio=payload.object_face_priority_ratio,
        identify_lane_enabled=payload.identify_lane_enabled,
        identify_backfill_enabled=payload.identify_backfill_enabled,
